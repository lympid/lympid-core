...
import com.lympid.core.behaviorstatemachines.pseudo.terminate.Test6.Context;
...
public class Test6 extends AbstractStateMachineTest<Context> {
  ...
  public void run() {
    SequentialContext expected = new SequentialContext()
      ...
      .exit("Aaaaa").effect("t1");
    
    Context ctx = new Context();
    StateMachineExecutor<Context> fsm = fsm(ctx);
    fsm.go();
    
    assertSnapshotEquals(fsm, new ActiveStateTree(this).branch("A", "Aa", "Aaa", "Aaaa"));
