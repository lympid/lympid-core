...
import com.lympid.core.behaviorstatemachines.pseudo.choice.Test5.Context;
  ...
  public StateMachineBuilder<Context> topLevelMachineBuilder() {
    ...
    builder
      .region()
        .initial()
          .transition("t0")
            .target(new ChoiceBuilder<Context>("myChoice")
              .transition("t1")
                .guard(c -> c.c == 2)
                .target("end")
              .transition("t2")
...
"    PseudoState: \"myChoice\" kind: CHOICE\n" +
"    Transition: \"t0\" --- #4 -> \"myChoice\"\n" +
"    Transition: \"t1\" --- \"myChoice\" -> \"end\"\n" +
"    Transition: \"t2\" --- \"myChoice\" -> \"end\"\n" +
"    Transition: \"t3\" --- \"myChoice\" -> \"end\"";
}
