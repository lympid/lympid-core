...
import com.lympid.core.behaviorstatemachines.pseudo.history.HistoryTest10.Context;
 ...
 */
public abstract class HistoryTest10 extends AbstractHistoryTest<Context> {
  ...
  public void run_P_a_b_c_end() {
    ...
    StateMachineExecutor<Context> fsm = fsm(ctx, configuration);
    fsm.go();
