...
/**
 * Tests an inner state activity is canceled when an outgoing transition of the 
 * owner state is fired.
 * 
...
public class Test7 extends AbstractStateMachineTest {
  ...
  public void run() throws InterruptedException {
    ...
    assertStateConfiguration(fsm, new ActiveStateTree(this).branch("A", "B").get());
