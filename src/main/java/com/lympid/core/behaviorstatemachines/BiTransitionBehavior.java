...
/**
 * Represents a transition behavior that accepts an event and a context argument
 * and returns no result. {@code BiTransitionBehavior} is expected to operate
 * via side-effects.
 *
 ...
 */
public interface BiTransitionBehavior<E extends Event, C> extends Behavior, BiConsumer<E, C> {
