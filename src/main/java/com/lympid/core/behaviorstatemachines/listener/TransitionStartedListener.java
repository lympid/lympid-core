 ...
 */
public interface TransitionStartedListener<C> {

  void onTransitionStarted(StateMachineExecutor executor, StateMachine machine, C context, Event event, Transition transition);
}
