 ...
 *
 * @see CompositeStateTransitionSource
 * @author Fabien Renaud
 */
public interface CompositeStateActivity<V extends StateBuilder<?, C>, C> extends CompositeStateTransitionSource<V, TransitionTrigger<V, C, CompletionEvent>, C, CompletionEvent> {
   ...
   * the composite/orthogonal state.
   */
  CompositeStateTransitionSource<V, TransitionTrigger<V, C, CompletionEvent>, C, CompletionEvent> activity(StateBehavior<C> activity);
   ...
   * the composite/orthogonal state.
   */
  CompositeStateTransitionSource<V, TransitionTrigger<V, C, CompletionEvent>, C, CompletionEvent> activity(Class<? extends StateBehavior<C>> activity);
}
