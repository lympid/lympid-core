 ...
 *
 * @see SelfTransitionEffect
 * @author Fabien Renaud
 */
public interface SelfTransitionGuard<V extends StateBuilder, C, E extends Event> extends SelfTransitionEffect<V, C, E> {
   ...
   */
  SelfTransitionEffect<V, C, E> guard(Class<? extends BiTransitionConstraint<E, C>> guard);
   ...
   * @return An interface to set the effect and target of the transition.
   */
  SelfTransitionEffect<V, C, E> guardElse(Class<? extends BiTransitionConstraint<E, C>> guard);
   ...
   * @return An interface to set the effect and target of the transition.
   */
  SelfTransitionEffect<V, C, E> guard(BiTransitionConstraint<E, C> guard);
