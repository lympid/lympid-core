...
public final class EntryPointBuilder<C> extends EntryPointReference<EntryPointBuilder<C>, C> implements PseudoStateTransitionSource<PseudoTransitionGuard<EntryPointReference<?, C>, C>> {
  ...
  public EntryPointBuilder(final String name) {
    super(name);
  }

  @Override
  public PseudoTransitionGuard<EntryPointReference<?, C>, C> transition(final String name) {
    PseudoErnalTransitionBuilder transition = new PseudoErnalTransitionBuilder(TransitionKind.LOCAL, name, this);
    outgoing().add(transition);
    return transition;
  }

  @Override
  public PseudoTransitionGuard<EntryPointReference<?, C>, C> transition() {
