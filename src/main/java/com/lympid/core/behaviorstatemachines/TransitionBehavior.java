...
/**
 * Represents a transition behavior that accepts a context as argument and
 ...
 */
public interface TransitionBehavior<C> extends BiTransitionBehavior<Event, C>, Consumer< C> {

  @Override
  default void accept(Event event, C context) {
    accept(context);
  }
}
